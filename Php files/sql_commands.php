...
class SqlCommand{
    ...
    public function select_tarhelyKeszletEllenorzes1()              {return "SELECT * FROM [dbo].[Tarhely_keszlet_ellenorzes] (:raktar_id, :tarhely_id)";}
    ...
    public function select_tabletBejovoszallitolevelUj()            {return "SELECT * FROM [dbo].[Tablet_Bejovoszallitolevel_uj] (:raktar_id)";}
    public function select_tabletCikkInfo()                         {return "SELECT * FROM [dbo].[Tablet_Cikk_info] (:id, :raktar_id)";}
    public function select_abroncs_reszletezo()                     {return "SELECT * FROM [local].[Abroncs_reszletezo] (:id)";}
    public function select_abroncs_reszletezo1()                    {return "SELECT * FROM [local].[Abroncs_reszletezo1] (:id, :tarhely_id)";}
    public function select_abroncsReszletezoPoziciokValasztas()     {return "SELECT * FROM [local].[Abroncs_reszletezo_poziciok_valasztas] (:id)";}
    public function select_abroncsReszletezoPoziciokValasztas1()    {return "SELECT * FROM [local].[Abroncs_reszletezo_poziciok_valasztas1] (:id)";}
    ...
    public function exec_finishOrders()                             {return "EXEC [dbo].[Tablet_Rendeles_Felvitele] :completed_orders";}
    public function exec_finishOrdersOut()                          {return "EXEC [dbo].[Tablet_Bevetelezes_Felvitele] :completed_orders";}
    public function exec_tabletKiszallitasFelvitele()               {return "EXEC [dbo].[Tablet_Kiszallitas_Felvitele] :completed_orders";}
    public function exec_finishPickUps()                            {return "EXEC [dbo].[Tablet_Kiszedes_Felvitele] :kiszedesi_lista";}
    public function exec_finishInventory()                          {return "EXEC [dbo].[RaktarmozgasFelvitele] :input";}
    public function exec_deleteItem()                               {return "EXEC [dbo].[NyitoleltarTorles] :cikk_id, :raktar_id";}
    ...
    public function exec_keszletmozgatasFelvitele()                 {return "EXEC [dbo].[KeszletmozgatasFelvitele] :parameter";}
    ...
    public function exec_barcodePrintTarhelyCikkek()                {return "EXEC [local].[Barcode_print_tarhely_cikkek] :bizonylat_id, :raktar_id, '[]'";}
    public function exec_barcodePrintFelvitele()                    {return "EXEC [local].[Barcode_print_Felvitele] :tarhely";}
    public function exec_barcodePrintBizonylatCikkek()              {return "EXEC [local].[Barcode_print_bizonylat_cikkek] :tarhely, :idk";}
