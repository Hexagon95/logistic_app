...
class SqlCommand{
    ...
    public function select_abroncs_reszletezo1()                {return "SELECT * FROM [" . $this->customer . "].[local].[Abroncs_reszletezo1] (:id, :tarhely_id)";}
    ...
    public function select_abroncsReszletezoPoziciokValasztas1() {return "SELECT * FROM [" . $this->customer . "].[local].[Abroncs_reszletezo_poziciok_valasztas1] (:id)";}
    ...
    public function exec_abroncs_reszletezo_felvitele1()         {return "EXEC [" . $this->customer . "].[local].[Abroncs_reszletezo_felvitele_temp1] :parameter";}
