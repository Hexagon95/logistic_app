...
class SqlCommand{
    ...
    public function select_tarhelyKeszlet()     {return "SELECT * FROM [" . $this->customer . "].[dbo].[Tarhely_keszlet] (0, :tarhely_id)";}    
    ...
    public function select_vonalkod()           {return "SELECT [id],[IP],[megnevezes] FROM [" . $this->customer . "].[dbo].[Cikk_kereses] (:vonalkod)";}
