...
class SqlCommand{
    ...
    public function select_tarhely_Id1()                            {return "SELECT * FROM [dbo].[Tarhely_id1] (:raktar_id, :input)";}
    ...
    public function select_tarhelyKeszletEllenorzes1()              {return "SELECT * FROM [dbo].[Tarhely_keszlet_ellenorzes1] (:raktar_id, :tarhely_id)";}
    public function select_keszletellenorzesId()                    {return "SELECT * FROM [dbo].[Keszletellenorzes_Id] (:code)";}
    public function select_keszletellenorzesId1()                   {return "SELECT * FROM [dbo].[Keszletellenorzes_Id1] (:raktar_id, :code)";}
    ...
    public function select_tabletCikkInfo()                         {return "SELECT * FROM [dbo].[Tablet_Cikk_info] (:id)";}
    ...
    public function exec_barcodePrintTarhelyCikkek()                {return "EXEC [local].[Barcode_print_tarhely_cikkek] :tarhely";}
